...
@section('title', 'Edit Menu | Warkop Sky CRM')
@section('page_title', 'Edit Menu: ' . $item->name)
...
@section('content')
    ...
    <div class="form-panel">
        ...
        <form action="{{ route('admin.menu.update', $item->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
            @csrf
            @method('PUT')
            ...
            <div class="form-grid">
                ...
                <!-- Image Upload Field -->
                <div class="form-group form-group-full">
                    <label class="form-label">Foto Menu (Ganti/Unggah Baru)</label>
                    <div class="file-upload-wrapper">
                        ...
                        <div class="file-upload-label" id="uploadLabel">
                            ...
                            <span id="fileName">
                                @if($item->image_path)
                                    Gambar aktif terdeteksi. Tarik file baru ke sini untuk mengganti.
                                @else
                                    Klik atau seret file gambar ke sini (Maksimal 3MB)
                                @endif
                            </span>
                        </div>
                    </div>
                    
                    <div class="image-preview-box" id="previewBox" style="{{ $item->image_path ? 'display:flex;' : 'display:none;' }}">
                        <img src="{{ $item->image_path ? asset($item->image_path) : '' }}" id="imgPreview" class="image-preview" alt="Pratinjau gambar">
                    </div>
                </div>
                ...
                <div class="form-group form-group-full">
                    ...
                    <div class="switch-group">
                        ...
                        <label class="custom-switch">
                            <input type="checkbox" name="is_available" class="switch-input" value="1" {{ old('is_available', $item->is_available) ? 'checked' : '' }}>
                        ...
                        <!-- Favorite Switch -->
                        <label class="custom-switch">
                            <input type="checkbox" name="is_favorite" class="switch-input switch-input--fav" value="1" {{ old('is_favorite', $item->is_favorite) ? 'checked' : '' }}>
                            <div class="switch-slider"></div>
