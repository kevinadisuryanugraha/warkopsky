...
@section('title', 'Tambah Kategori Menu Baru | Warkop Sky CRM')
@section('page_title', 'Tambah Kategori Menu Baru')
...
@section('content')
    ...
    <div class="form-panel">
        ...
        <form action="{{ route('admin.menu.category.store') }}" method="POST" autocomplete="off">
            @csrf
            ...
            <div class="form-grid">
                ...
                <!-- Column Position -->
                <div class="form-group">
                    <label for="column_position" class="form-label">Posisi Kolom Tampil *</label>
                    <select name="column_position" id="column_position" class="form-control" style="cursor: pointer;" required>
                        <option value="left" {{ old('column_position') == 'left' ? 'selected' : '' }}>Kiri (Left Column)</option>
                        <option value="right" {{ old('column_position') == 'right' ? 'selected' : '' }}>Kanan (Right Column)</option>
                    </select>
                </div>
            ...
            <div class="form-actions">
                <a href="{{ route('admin.menu.categories.index') }}" class="btn-cancel">Batal</a>
